    ...
    head() {
        return {
            ...
            meta: [
                ...
                { hid: 'description', name: 'description', content: '青蓝up的Blog Detail Page' },
                { property: 'og:title', content: `${this.pagetitle} 青蓝up`},
                { property: 'og:type', content: `${this.pagetitle} 青蓝up`},
                { property: 'og:description', content: `${this.pagetitle} 青蓝up`}
            ]
        }
    },
    data() {
