<template>
    <section class="homePage">
        <section class="homePage-header">
            ...
            <h1 class="header-title" data-value="HI, TRAVELLER!">
                HI, TRAVELLER!
            </h1>
            <div class="header-tip">
                ...
                <ul class="header-recom">
                    <li class="lt" data-value='~~ 向左一点点 ~~' @click="bannerChangeBack"><i class="iconfont icon-xiangzuoxiangyou-copy-copy"></i></li>
                    ...
                    <li class="gt" @click="bannerChangego" data-value='~~ 向右一点点 ~~'><i class="iconfont icon-gt"></i></li>
                </ul>
            </div>
        </section>
...
export default {
    ...
    scrollToTop: true,
    head: {
        title: '~~青蓝up || Home Page',
        meta: [
            { charset: 'utf-8' },
            { name: 'viewport', content: 'width=device-width, initial-scale=1' },
            { hid: 'description', name: 'description', content: '青蓝up的首页' },
